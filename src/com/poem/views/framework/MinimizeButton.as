package com.poem.views.framework 
{
	 ...
	 * @author Ken Songer
	 */
	public class MinimizeButton extends Sprite implements IDisposable, IInitializable
	{
		[Inject]
		...
		public function initialize() : void
		{
			...
			backgroundLoader.load(new URLRequest(model.config.minimizeButtonImageURL));
